...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    role="table"
    className={mergeClasses("bg-background relative caption-bottom text-sm", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={mergeClasses(
      "even:bg-muted/40 data-[state=selected]:bg-muted h-10 border-b transition-colors flex last:border-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ...
    role="cell"
    className={mergeClasses(
      "p-2 px-4 align-middle [&:has([role=checkbox])]:pr-0 truncate",
      className
    )}
    {...props}
  />
