  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-white">
            ...
            <SheetContent side="left" className="flex flex-col justify-between">
              <div>
                <SheetHeader className="mb-8">
                  ...
                  <SheetDescription>
                    Ebooks práticos + acesso imediato. Ao comprar, você recebe números
                    vinculados ao seu pedido para participar de campanhas de prêmios.
                  </SheetDescription>
                </SheetHeader>
        ...
        <div className="hidden sm:flex flex-row items-center justify-between w-full max-w-6xl">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <p className="text-xs text-white/90">Ebooks com acesso imediato</p>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid gap-10 sm:grid-cols-2 items-center">
          <div className="flex flex-col gap-5">
            ...
            <h1 className="text-3xl sm:text-4xl font-semibold text-gray-900">
              Ebooks que você usa de verdade — e ainda participa de campanhas especiais
            </h1>
            <p className="text-gray-700 leading-relaxed">
              Aqui você encontra ebooks digitais com acesso imediato. Ao finalizar a
              compra, seu pedido gera números vinculados ao seu cadastro — eles entram
              nas campanhas de prêmios ativas, conforme regras e datas publicadas.
            </p>
          ...
          <div className="bg-white border border-green-200 rounded-xl p-6">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex gap-3">
                ...
                <span>
                  Ebooks em categorias práticas: aprendizado, produtividade e guias.
                </span>
              </li>
              <li className="flex gap-3">
                <Download className="h-5 w-5 text-green-700" />
                <span>
                  Acesso imediato após a confirmação do pedido, direto na sua conta.
                </span>
              </li>
              <li className="flex gap-3">
                <Gift className="h-5 w-5 text-green-700" />
                <span>
                  Números gerados no pedido para entrar nas campanhas de prêmios ativas.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="border rounded-xl p-6">
              <div className="flex items-center gap-2 mb-2">
                <BookOpen className="h-5 w-5 text-green-700" />
                <h3 className="font-semibold text-gray-900">1) Escolha seu ebook</h3>
              </div>
              <p className="text-gray-700">
                Navegue pelo catálogo e selecione o conteúdo que faz sentido para você.
              </p>
            </div>
            <div className="border rounded-xl p-6">
              <div className="flex items-center gap-2 mb-2">
                <Download className="h-5 w-5 text-green-700" />
                <h3 className="font-semibold text-gray-900">2) Finalize e receba</h3>
              </div>
              <p className="text-gray-700">
                Após a confirmação, o acesso fica disponível na sua conta para baixar e
                usar.
              </p>
            </div>
            <div className="border rounded-xl p-6">
              ...
              <p className="text-gray-700">
                Seu pedido gera números vinculados ao cadastro. Quando houver campanhas
                ativas, eles entram automaticamente conforme as regras publicadas.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Guias práticos</h3>
              <p className="text-gray-700">
                Conteúdo direto ao ponto, passo a passo, para aplicação imediata.
              </p>
            </div>
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Aprendizado</h3>
              <p className="text-gray-700">
                Materiais para evoluir em temas específicos com exemplos e exercícios.
              </p>
            </div>
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Produtividade</h3>
              <p className="text-gray-700">
                Métodos, checklists e rotinas para organizar e ganhar consistência.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="seguranca" className="px-6 py-12">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Segurança</h2>
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Compra e acesso</h3>
              <p className="text-gray-700">
                Pagamento confirmado, acesso liberado. Seus downloads ficam associados
                ao seu cadastro.
              </p>
            </div>
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Regras publicadas</h3>
              <p className="text-gray-700">
                Quando houver campanha, você visualiza critérios, datas, status e a
      ...
      <section id="funcionalidades" className="px-6 py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Funcionalidades</h2>
          <div className="grid gap-6 sm:grid-cols-3">
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Catálogo de ebooks</h3>
              <p className="text-gray-700">
                Navegação por categorias e acesso rápido ao que você comprou.
              </p>
            </div>
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Área do comprador</h3>
              <p className="text-gray-700">
                Histórico de pedidos, downloads disponíveis e dados do seu cadastro.
              </p>
            </div>
            <div className="border bg-white rounded-xl p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Campanhas de prêmios</h3>
              <p className="text-gray-700">
          ...
          <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
            <div>
              ...
              <p className="text-white/90 mt-2">
                Crie sua conta para comprar ebooks, acessar downloads e acompanhar
                campanhas quando disponíveis.
              </p>
            </div>
      ...
      <footer className="px-6 py-10 border-t pb-[calc(env(safe-area-inset-bottom,0)+2.5rem)]">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
          ...
          <div className="text-sm text-gray-600">
            <p>
              © {new Date().getFullYear()} Golden Book. Todos os direitos reservados.
            </p>
